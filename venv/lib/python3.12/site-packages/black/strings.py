...
def normalize_string_quotes(s: str) -> str:
    ...
    if "r" in prefix.casefold():
        ...
        new_body = sub_twice(escaped_orig_quote,
                             rf"\1\2{orig_quote}", new_body)
        new_body = sub_twice(unescaped_new_quote,
                             rf"\1\\{new_quote}", new_body)
...
def normalize_fstring_quotes(
    ...
    for middle in middles:
        ...
        new_segment = sub_twice(unescaped_new_quote,
                                rf"\1\\{new_quote}", new_segment)
