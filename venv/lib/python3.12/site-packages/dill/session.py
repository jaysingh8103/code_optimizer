...
IMPORTED_AS_TYPES = (ModuleType, TypeType, FunctionType,
...
def _stash_modules(main_module):
    ...
    for name, obj in main_module.__dict__.items():
        ...
        # Avoid incorrectly matching a singleton value in another package (ex.: __doc__).
            ...
            source_module, objname = _lookup_module(
                modmap, name, obj, main_module)
    ...
    for old_par, par in [('main', 'module'), ('byref', 'refimported')]:
        if old_par in kwds:
            ...
            if locals()[par]:  # the defaults are None and False
                raise TypeError(
                    "both %r and %r arguments were used" % (par, old_par))
    ...
    def peek(self, n):
        ...
        try:
            ...
            raise NotImplementedError(
                "stream is not peekable: %r", stream) from None
